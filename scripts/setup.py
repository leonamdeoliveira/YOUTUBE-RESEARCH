...
def download_model():
    """Baixa o modelo sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2."""
    print("Verificando modelo sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2...")
    try:
        from sentence_transformers import SentenceTransformer
        model = SentenceTransformer('sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2')
        print("  Modelo sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2 OK")
        return True
